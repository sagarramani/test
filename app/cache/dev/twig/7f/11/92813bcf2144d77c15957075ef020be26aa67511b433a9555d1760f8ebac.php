...
/* adminBundle:comman_admin:ChangePassword.html.twig */
class __TwigTemplate_7f1192813bcf2144d77c15957075ef020be26aa67511b433a9555d1760f8ebac extends Twig_Template
{
...
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Username</p>
\t\t\t\t<input class=\"input_style7\" type=\"text\" name=\"Username\" id=\"Username\" />
            </div>
            
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">OldPassword</p>
\t\t\t\t<input class=\"input_style7\" type=\"text\" name=\"OldPassword\" id=\"OldPassword\" />
            </div>
            
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">NewPassword</p>
\t\t\t\t<input class=\"input_style7\" type=\"text\" name=\"NewPassword\" id=\"NewPassword\" /></div>
...
\t\t\t\t<input class=\"input_style7\" type=\"text\"  name=\"Mobile\" id=\"Mobile\"/>
            </div>
\t\t\t
\t\t\t<div class=\"full_w\">
\t\t\t<input type=\"radio\" name=\"sex\" id=\"sex\" value=\"agree\">agree 
\t\t\t<input type=\"radio\" name=\"sex\" id=\"sex\" value=\"disagree\">disagree
\t\t\t
\t    </div>
\t\t\t
\t\t\t<br>
\t\t\t<div class=\"full_w\">
\t\t\t\t<input class=\"input_style7\" type=\"submit\" value=\"Change Password\" />
            </div>
        </form>    
\t\t\t
\t\t\t
...
";
    ...
    {
        return "adminBundle:comman_admin:ChangePassword.html.twig";
    }
