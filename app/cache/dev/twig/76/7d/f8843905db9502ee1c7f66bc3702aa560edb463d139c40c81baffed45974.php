...
/* adminBundle:PEP:AI_Animal_Movement.html.twig */
class __TwigTemplate_767df8843905db9502ee1c7f66bc3702aa560edb463d139c40c81baffed45974 extends Twig_Template
{
...
\t\t\t
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Age</p>
...
\t\t\t
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">location</p>
\t\t\t\t<select class=\"select_style5\" name=\"AI_center\" id=\"AI_center\"><option>Select Value</option></select>
            </div>
\t\t\t
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">last calving date</p>
\t\t\t\t<select class=\"select_style8\" name=\"date\" id=\"name=\"date\"><option>Date</option></select>
\t\t\t\t<select class=\"select_style8\" name=\"November\" id=\"November\"><option>November</option></select>
\t\t\t\t<select class=\"select_style8\" name=\"Year\" id=\"Year\"><option>Year</option></select>
            </div>
...
";
    ...
    {
        return "adminBundle:PEP:AI_Animal_Movement.html.twig";
    }
