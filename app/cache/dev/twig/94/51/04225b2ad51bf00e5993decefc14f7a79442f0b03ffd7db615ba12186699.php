...
/* adminBundle:union_admin:UserMaster.html.twig */
class __TwigTemplate_945104225b2ad51bf00e5993decefc14f7a79442f0b03ffd7db615ba12186699 extends Twig_Template
{
...
\t\t<h1 class=\"main_heading\">user master</h1>
...
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Full Name</p>
\t\t\t\t<input class=\"input_style7\" type=\"text\" name=\"Full_Name\" id=\"name=\"Full_Name\"/>
            </div>
            
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Login ID</p>
\t\t\t\t<input class=\"input_style7\" type=\"text\" name=\"Login_ID\" id=\"Login_ID\" />
            </div>
            
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Password</p>
\t\t\t\t<input class=\"input_style7\" type=\"text\" name=\"Password\" id=\"Password\"/></div>
            
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Confirm Password</p>
\t\t\t\t<input class=\"input_style7\" type=\"text\" name=\"c_password\" id=\"c_password\"/>
            </div>
            
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Email</p>
\t\t\t\t<input class=\"input_style7\" type=\"text\" name=\"email\" id=\"email\"/>
            </div>
\t\t\t
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Login Operation</p>
\t\t\t\t<select class=\"select_style5\" name=\"login_operation\" id=\"login_operation\">
\t\t\t\t\t<option>FIP Head</option>
\t\t\t\t\t<option>PEP Head</option>
\t\t\t\t\t<option>Gauchar Land Data Entry Operator</option>
\t\t\t\t\t<option> Animal Survey</option>
\t\t\t\t\t<option> Data Entry Operator</option>
\t\t\t\t</select>
            </div>
            
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Login Type</p>
\t\t\t\t<select class=\"select_style5\" name=\"login_type\" id=\"login_type\">
\t\t\t\t\t<option>FIP</option>
\t\t\t\t\t<option>PEP</option>
\t\t\t\t\t<option>FIP AND PEP</option>
\t\t\t\t\t<option>FIP and PMP</option>
...
\t\t\t
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Change Password at First Login</p>
\t\t\t\t<select class=\"select_style5\" name=\"c_pwd_login\" id=\"c_pwd_login\">
...
\t\t\t
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">FIP Meeting Member</p>
\t\t\t\t<select class=\"select_style5\" name=\"fip_member\" id=\"fip_member\">
...
\t\t\t
\t\t\t<div class=\"full_w\">
\t\t\t\t<p class=\"body_white_panne_text_style1\">Status</p>
\t\t\t\t<select class=\"select_style5\" name=\"status\" id=\"status\">
\t\t\t\t\t<option hidden>select</option>
...
";
    ...
    {
        return "adminBundle:union_admin:UserMaster.html.twig";
    }
    ...
    {
        return array (  357 => 255,  221 => 116,  217 => 115,  213 => 114,  209 => 113,  192 => 99,  185 => 95,  181 => 94,  177 => 93,  168 => 87,  164 => 86,  160 => 85,  156 => 84,  152 => 83,  142 => 76,  138 => 75,  134 => 74,  130 => 73,  125 => 71,  119 => 68,  115 => 67,  111 => 66,  107 => 65,  103 => 64,  99 => 63,  96 => 62,  92 => 56,  89 => 55,  85 => 38,  81 => 37,  77 => 36,  73 => 34,  48 => 11,  45 => 10,  38 => 6,  35 => 5,  30 => 3,);
    }
}
