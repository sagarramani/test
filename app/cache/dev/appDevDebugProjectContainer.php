...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            'kernel.root_dir' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev',
            'kernel.logs_dir' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'RegisterBundle' => 'AcmeRegisterBundle\\RegisterBundle',
                'ContactusBundle' => 'AcmecontactusBundle\\ContactusBundle',
                'adminBundle' => 'Acme\\adminBundle\\adminBundle',
            ...
            'session.save_path' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/assetic/routing.yml',
            ...
            'debug.container.dump' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/../web',
            'assetic.write_to' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/doctrine/orm/Proxies',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'test1', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array((dirname(dirname(dirname(__DIR__))).'\\src\\AcmeRegisterBundle\\Resources\\config\\doctrine') => 'AcmeRegisterBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'AcmeRegisterBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('RegisterBundle' => 'AcmeRegisterBundle\\Entity'));
        ...
        $c->setProxyDir('C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b643a16ba2bac80626ddbd9a88e2e30cdb0cf0949e58bacdfa2158a518c7d3a1');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\AcmeRegisterBundle/Resources/views'), 'Register');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\AcmecontactusBundle/Resources/views'), 'Contactus');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\adminBundle/Resources/views'), 'admin');
        ...
        $instance->addPath('C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/Resources/views');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Bitnami/wappstack-5.4.35-0/apache2/htdocs/Symfony/app/cache/dev');
    }
